...
task autonomous()
{
  ...
  //
	...
	//	int UH = 50;                                     // Universal Haults
		...
		clearDrive();
		driveForwardPid(850, 100);                        // Forward
		haultDrive(UH);
		clearDrive();
  ...
  //
	...
	case 3:
   	...
   	//	int UH = 50;                                     // Universal Haults
		...
		clearDrive();
		driveForwardPid(950, 100);                        // Forward
		haultDrive(UH);
		clearDrive();
  ...
  //
	...
	//	haultDrive(10);
		...
		clearDrive();
		driveForwardPid(180);                            // Forward to line up with middle cube
		haultDrive(UH);
		clearDrive();
		clearGyro();
		liftTime(127, 450);
		...
		gyroTurn(600, 'r');                             // Turn left to line up with cube
		haultDrive(UH);
		clearDrive();

		driveForwardPid(1000, 110);                     // Drive into Cube
		haultDrive(UH);
		clearDrive();
		pickUp();
		liftTime(127, 300);
