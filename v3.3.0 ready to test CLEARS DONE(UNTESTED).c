...
task autonomous()
{
	...
	case 0:
		...
		driveForwardPid(800, 50);                        // Forward
		haultDrive(UH);
		clearDrive();
		...
		curlOut(300, -100, -70);                         // Hopefully this works - will have to change numbers - biggest tune prpbabkly
		clearDrive();
		haultDrive(UH);
    ...
    lift2Bottom();
		...
		driveForwardPid(500);                            // Get to starting tile to load 3nd time ***
		haultDrive(UH);
		clearDrive();
    ...
    lift2Bottom();
		...
		driveForwardPid(200);                            // Forward to line up with middle cube
		haultDrive(UH);
		clearDrive();
		clearGyro();
		gyroTurn(900, 'l');                              // Turn left to line up with cube
		haultDrive(UH);
		clearDrive();

		driveForwardPid(600, 80);                        // Drive into Cube
		haultDrive(UH);
		clearDrive();
		pickUp();                                        // Pick cube up
		startTask(liftHolder);
		...
		clearGyro();
		gyroTurn(900, 'l', 40);                          // Turn to face fence
    stopTask(liftHolder);
    score(400);                                      // Score
    haultAll(UH);
    clearDrive();
