...
task autonomous()
{
  ...
  //
	...
	//	haultDrive(10);
		...
		clearDrive();
		driveForwardPid(20);                            // Forward to line up with middle cube
		haultDrive(UH);
		clearDrive();
		clearGyro();
		liftTime(127, 450);
    ...
    lift2Bottom();
		...
		break;
	case 4:
		displayLCDCenteredString(0, "2Star1CubeMain");
		displayLCDCenteredString(1, "is running!");
   	...
   	//	int UH = 50;                                     // Universal Haults
		...
		clearDrive();
		driveForwardPid(510);                            // Forward to line up with middle cube
		haultDrive(UH);
		clearDrive();
		clearGyro();
		liftTime(127, 450);
	...
	case 5:
		//If count = 2, run the code correspoinding with choice 3
		displayLCDCenteredString(0, "5 Star Main Tile M");
		displayLCDCenteredString(1, "is running!");
