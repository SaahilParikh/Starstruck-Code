...
int releaseThreshold = 500; // needs to be set correctly later
...
task usercontrol()
{
	...
	while (true)
	{
		...
		if(vexRT[Btn5D] == 1 || nMotorEncoder[liftRightEnc] > releaseThreshold || nMotorEncoder[liftLeftEnc] > releaseThreshold)
		{
			openClaw();
		}
