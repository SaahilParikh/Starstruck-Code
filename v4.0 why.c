	...
	while(nMotorEncoder[liftLeftEnc] < releaseThreshold+150 || nMotorEncoder[liftRightEnc] < releaseThreshold+150)
		{
			...
			openClaw();
			motor[liftLeftEnc] = 90;
			motor[liftLeftIn] = 90;
			motor[liftLeftTop] = 90;
			motor[liftRightEnc] = 90;
			motor[liftRightIn] = 90;
...
task autonomous()
{
  ...
  //
    ...
    lift2Bottom();
		...
		clearDrive();
		driveForwardPid(750);                            // Go for Second Ground Cube
		haultDrive(UH);
		pickUp();
		startTask(liftHolder);
		clearDrive();
		...
		clearDrive();
		driveForwardPid(150);                            // go forward to not hit fence
		haultDrive(100);
		clearGyro();
		...
		clearDrive();
		driveForwardPid(1000);                           // Drive into the front three stars
		haultDrive(10);
