...
task autonomous()
{
	...
	case 0:
		...
		clearDrive();
		driveForwardPid(1100, 100);                        // Forward
		haultDrive(UH);
		clearDrive();
  ...
  //
	...
	//	int UH = 50;                                     // Universal Haults
		...
		clearDrive();
		driveForwardPid(900, 100);                        // Forward
		haultDrive(UH);
		clearDrive();
...
driveTime(-127, 200);
  ...
  //
	...
	//	haultDrive(10);
		...
		gyroTurn(500, 'l', 40, 300);                             // Turn left to line up with cube
		haultDrive(UH-40);
		clearDrive();
   ...
   // lift2Bottom();
	...
	case 9:
   	...
   	//	int UH = 50;                                     // Universal Haults
		...
		gyroTurn(600, 'l', 40, 300);                             // Turn left to line up with cube
		haultDrive(UH-40);
		clearDrive();
