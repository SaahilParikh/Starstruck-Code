...
bool hangButtonIsPressed = false;
bool isDone = false;
...
void gyroTurn(int degrees, char direction, int minSpeed = 30, int stationaryCountLimit = 3000)
{
	int dir = 1;
...
void curlOut(int backUpDistance, int rightSidePower, int leftSidePower, int degrees = 900)
{
	...
	while(!auton)
	{
		if(bIfiRobotDisabled) // true is diabled false is enabled check this tmmr
		{
			...
			case 2:
				...
				displayLCDCenteredString(0, "5 Stars Main Tile");
				displayLCDCenteredString(1, "<     Enter    >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 3:
				//Display fourth choice
				displayLCDCenteredString(0, "4Star1CubeMain");
				displayLCDCenteredString(1, "<     Enter    >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 4:
				//Display fourth choice
				displayLCDCenteredString(0, "2 Star main");
				displayLCDCenteredString(1, "<     Enter    >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 5:
				//Display fourth choice
				displayLCDCenteredString(0, "2 Star 1 Cube");
				displayLCDCenteredString(1, "<     Enter    >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 6:
				//Display fourth choice
				displayLCDCenteredString(0, "5 Star M");
				displayLCDCenteredString(1, "<     Enter    >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 7:
				//Display fourth choice
				displayLCDCenteredString(0, "4 Star 1 Cube M");
				displayLCDCenteredString(1, "<     Enter    >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 8:
				//Display fourth choice
				displayLCDCenteredString(0, "2 Star M");
				displayLCDCenteredString(1, "<     Enter    >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
			...
			case 9:
				//Display fourth choice
				displayLCDCenteredString(0, "2 Star 1 Cube M");
				displayLCDCenteredString(1, "<     Enter    >");
				waitForPress();
				//Increment or decrement "count" based on button press
				if(nLCDButtons == leftButton)
...
task autonomous()
{
	...
	case 0:
		...
		openClaw();                                      // Deploy
		haultAll(400);                                   // Wait until claw actually falls

		clearDrive();
		driveForwardPid(1000, 100);                        // Forward
		haultDrive(UH);
		clearDrive();
		...
		wait1Msec(320);
		clearDrive();
		//curlOut(420, -125, -10, 900);
		curlOut(0, -125, -18, 900);
		motor[driveLeftBack] = -127;
		motor[driveLeftFront] = -127;
		motor[driveRightBack] = 127;
		motor[driveRightFront] = 127;
  ...
  //
	...
	//	haultDrive(10);
		...
		clearLift();
		clearDrive();
		stopTask(liftHolder);																			 // Important Score Function - might have to change number
		driveTime(-127, 300);
		haultDrive(10);
		clearLift();
    ...
    lift2Bottom();
		...
		clearDrive();
		driveForwardPid(480);                            // Forward to line up with middle cube
		haultDrive(UH);
		clearDrive();
		clearGyro();
		liftTime(127, 450);
		...
		driveForwardPid(2400, 110);                     // Drive into Cube
		haultDrive(UH);
		clearDrive();
		pickUp();
		liftTime(127, 500);
    ...
    lift2Bottom();
		...
		haultLift(10);
		clearGyro();
		gyroTurn(1000, 'l', 100, 1000)                                 // Turn Right to line up with stars
		haultDrive(10);
		...
		clearGyro();
		gyroTurn(900, 'r', 120, 500)                                 // Turn Left to line up with fence
		haultDrive(100);
	...
	case 1:
		...
		clearDrive();
		driveForwardPid(200); // turn for first corner star
		haultDrive(10);
		...
		clearDrive();
		driveForwardPid(1100); // forward for 3rd driverload
		haultDrive(10);
	...
	case 2:
		...
		displayLCDCenteredString(0, "5 Star Main Tile");
		displayLCDCenteredString(1, "is running!");
  ...
  //
	...
	//	haultDrive(10);
		...
		clearDrive();
		driveForwardPid(1200);                            // Get to starting tile to load
		haultDrive(100);
		clearDrive();
  ...
  //
	...
	//	haultDrive(10);
		...
		clearDrive();
		driveForwardPid(30);                            // Forward to line up with middle cube
		haultDrive(UH-40);
		clearDrive();
		clearGyro();
		liftTime(127, 250);
		...
		gyroTurn(600, 'r', 40, 300);                             // Turn left to line up with cube
		haultDrive(UH-40);
		clearDrive();

		driveForwardPid(1200, 110);                     // Drive into Cube
		haultDrive(UH-40);
		clearDrive();
		pickUp();
		liftTime(127, 200);
		...
		clearDrive();
		//driveBackwardPid(200);

		haultDrive(10);

		clearGyro();
		gyroTurn(600, 'l', 100, 200);
		haultAll(10);
		motor[driveLeftBack] = 127;
		motor[driveLeftFront] = 127;
		motor[driveRightBack] = -127;
   ...
   // lift2Bottom();
		...
		break;
	case 4:
		displayLCDCenteredString(0, "2Star");
		displayLCDCenteredString(1, "is running!");
...
driveTime(-127, 200);
    ...
    lift2Bottom();
		...
		break;
	case 5:
		displayLCDCenteredString(0, "2Star1Cube");
		displayLCDCenteredString(1, "is running!");
  ...
  //
	...
	//	haultDrive(10);
		...
		clearDrive();
		stopTask(liftHolder);
		driveBackwardPID(200);																			 // Important Score Function - might have to change number
		driveTime(-127, 500);
		haultDrive(10);
		clearLift();
	...
	case 7:
		//If count = 3, run the code correspoinding with choice 3
		displayLCDCenteredString(0, "4Star1CubeMain M");
		displayLCDCenteredString(1, "is running!");
  ...
  //
	...
	//	haultDrive(10);
		...
		gyroTurn(550, 'l', 40, 300);                             // Turn left to line up with cube
		haultDrive(UH-40);
		clearDrive();
   ...
   // lift2Bottom();
		...
		break;
	case 8:
		displayLCDCenteredString(0, "2Star M");
		displayLCDCenteredString(1, "is running!");
    ...
    //lift2Bottom();
		...
		break;
	case 9:
		displayLCDCenteredString(0, "2Star1Cube M");
		displayLCDCenteredString(1, "is running!");
   	...
   	//	int UH = 50;                                     // Universal Haults
		...
		clearDrive();
		driveForwardPid(40);                            // Forward to line up with middle cube
		haultDrive(UH-40);
		clearDrive();
		clearGyro();
		liftTime(127, 250);
		...
		gyroTurn(600, 'l', 40, 500);                             // Turn left to line up with cube
		haultDrive(UH-40);
		clearDrive();

		driveForwardPid(1500, 110);                     // Drive into Cube
		haultDrive(UH-40);
		clearDrive();
		pickUp();
		liftTime(127, 200);
...
task usercontrol()
{
	...
	while (true)
	{
		...
		if(vexRT[Btn8D] == 1){
			hangButtonIsPressed = false;
			isDone = false;
		}
		else if(vexRT[Btn8U] == 1)
		{
			hangButtonIsPressed = true;
			isDone = false;
		}
		...
		else
		{
			...
			else if(hangButtonIsPressed)
			{
				motor[liftLeftEnc] = -50;
				motor[liftLeftIn] = -50;
				motor[liftLeftTop] = -50;
				motor[liftRightEnc] = -50;
				motor[liftRightIn] = -50;
